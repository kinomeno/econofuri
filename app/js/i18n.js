...
const I18N = {
  ja: {
    ...
    // プライバシー
    privacy: 'すべてブラウザ内で処理し、ファイルは外部に送信しません（訪問数のみ匿名で記録）。',
    ...
    howNote: 'すべてブラウザ内で処理。ファイルは外部に送信しません（訪問数のみ匿名で記録）。',
    supportTitle: '気に入ったら…',
  ...
  en: {
    ...
    privacy: 'Everything runs in your browser. Files are never sent externally (only anonymous visit counts are recorded).',
    ...
    howNote: 'Everything runs in your browser. Files are never sent externally (only anonymous visit counts are recorded).',
